...
namespace AgOpenGPS
{
    public partial class CBoundary
    {
        ...
        //    {
        //        for (int i = 0; i < mf.bnd.buildList[j].turnLine.Count - 1; i++)
        //        {
        //            int res = mf.yt.GetLineIntersection(
        //                mf.bnd.buildList[j].turnLine[i].easting,
        //                mf.bnd.buildList[j].turnLine[i].northing,
        //                mf.bnd.buildList[j].turnLine[i + 1].easting,
        //                mf.bnd.buildList[j].turnLine[i + 1].northing,
        ...
        //                double hed = Math.Atan2(mf.bnd.buildList[j].turnLine[i + 1].easting - mf.bnd.buildList[j].turnLine[i].easting,
        //                    mf.bnd.buildList[j].turnLine[i + 1].northing - mf.bnd.buildList[j].turnLine[i].northing);
