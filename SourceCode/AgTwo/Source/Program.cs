...
namespace AgTwo
{
    ...
    {
        private static readonly Mutex Mutex = new Mutex(true, "{8F6F0AC4-B9A1-5500-A8CF-72F14E6BDE8F}");
        ...
        private static void Main()
        {
            ...
            Log.EventWriter("AgTwo Version: " + Application.ProductVersion.ToString(CultureInfo.InvariantCulture));
