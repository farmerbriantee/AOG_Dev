...
namespace AgOpenGPS
{
    public partial class FormAllSettings : Form
    {
        ...
        private void LoadLabels()
        {
            ...
            label110.Text = Settings.Tool.setSection_isFast.ToString();
            label112.Text = Settings.Tool.setTool_isSectionOffWhenOut.ToString();
            label114.Text = Settings.Tool.setTool_isSectionsNotZones.ToString();
            label116.Text = Settings.Tool.setTool_isToolFront.ToString();
            label118.Text = Settings.Tool.setTool_isToolRearFixed.ToString();
            label120.Text = Settings.Tool.setTool_isToolTBT.ToString();
            label122.Text = Settings.Tool.setTool_isToolTrailing.ToString();

            label124.Text = Settings.Tool.setTool_toolTrailingHitchLength.ToString();
            label126.Text = Settings.Tool.setTool_trailingToolToPivotLength.ToString();
            label128.Text = Settings.Tool.setVehicle_hitchLength.ToString();
            label130.Text = Settings.Tool.setVehicle_hydraulicLiftLookAhead.ToString();
            label132.Text = "~~~";
            ...
            label142.Text = Settings.Tool.setVehicle_numSections.ToString();
            label144.Text = Settings.Tool.setVehicle_slowSpeedCutoff.ToString();
            label146.Text = Settings.Tool.setVehicle_tankTrailingHitchLength.ToString();
            label148.Text = Settings.Tool.setVehicle_toolLookAheadOn.ToString();
            label150.Text = Settings.Tool.setVehicle_toolLookAheadOff.ToString();
            label152.Text = Settings.Tool.setVehicle_toolOffDelay.ToString();
            label154.Text = Settings.Tool.setVehicle_toolOffset.ToString();
            label156.Text = Settings.Tool.setVehicle_toolOverlap.ToString();
            label158.Text = Settings.Tool.setVehicle_toolWidth.ToString();
