...
namespace AgOpenGPS
{
    public partial class FormAllSettings : Form
    {
        ...
        private void LoadLabels()
        {
            ...
            label124.Text = Properties.ToolSettings.Default.setTool_toolTrailingHitchLength.ToString();
            label126.Text = Properties.ToolSettings.Default.setTool_trailingToolToPivotLength.ToString();
            label128.Text = Properties.ToolSettings.Default.setVehicle_hitchLength.ToString();
